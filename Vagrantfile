  ...
  config.vm.define "apiserver" do |apiserver|
    ...
    apiserver.trigger.after :up do |trigger|
      trigger.run_remote = {inline: <<-SHELL
        ...
        curl -v -s -H "Content-Type: application/json" http://localhost:8080/apis/v1/cluster/create -X POST -d '{\"id\":\"1b8624d9-b3cf-41a3-a95b-748277484ba5\",\"name\":\"cluster1\",\"expected_etcd_count\":3,\"pod_network_cidr\":\"55.55.0.0/12\",\"service_cidr\":\"10.254.1.1/12\",\"kubernetes_version\":\"1.13.8\",\"service_dns_domain\":\"cluster.local\",\"service_dns_cluster_ip\":\"10.254.210.250\",\"ha_settings\":{\"vip\":\"192.168.33.100\",\"router_id\":\"40\",\"count\":2},\"network_stack\":{\"type\":\"kuberouter\"},\"dns_deployment_settings\":{\"type\":\"coredns\"},\"ext_deployments\":{\"prometheus\":{},\"metric-server\":{}}}'
        SHELL
        }
    end
  end
